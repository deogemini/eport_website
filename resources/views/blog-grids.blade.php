...
@section('title', 'Blog Grids | EPORT SOLUTIONS LIMITED')
          ...
          <div class="w-full px-4">
            <div class="text-center">
              ...
              <p class="mb-5 text-base text-body-color dark:text-dark-6">
                Stay updated with the latest news and insights from EPORT SOLUTIONS LIMITED.
              </p>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="mb-10 wow fadeInUp group" data-wow-delay=".1s">
              <div class="mb-8 overflow-hidden rounded-[5px]">
                <a href="{{ route('blog-details') }}" class="block">
                  <img
