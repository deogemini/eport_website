...
@section('title', 'About | EPORT SOLUTIONS LIMITED')
            ...
            <div class="w-full px-4 lg:w-1/2">
              <div class="flex flex-wrap -mx-2 sm:-mx-4 lg:-mx-2 xl:-mx-4">
                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  ...
                  >
                    <img
                      src="{{ asset('assets/images/about/about-image-01.jpg') }}"
                      alt="about image"
                ...
                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  ...
                  >
                    <img
                      src="{{ asset('assets/images/about/about-image-02.jpg') }}"
                      alt="about image"
                      class="object-cover object-center w-full h-full"
                    />
                  </div>
                ...
                >
                  ...
                  >
                    ...
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M42.5094 33.0404C43.3438 33.0404 44.0599 32.3462 44.0599 31.4899C44.0599 30.6336 43.3657 29.9395 42.5094 29.9395C41.6531 29.9395 40.959 30.6336 40.959 31.4899C40.959 32.3462 41.6531 33.0404 42.5094 33.0404Z"
                      fill="#3056D3"
                    />
                    <path
                      fill-rule="evenodd"
